-- ExamsGraph Database Schema
-- Run this in Supabase SQL Editor: https://app.supabase.com/project/ahtyeydsrndmqxlcaavm/editor
...
CREATE TABLE IF NOT EXISTS public.subscriptions (
    ...
    payment_method TEXT, -- 'card', 'admin_promotional', 'admin_force'
...
-- Study Sets: Users can manage their own study sets
