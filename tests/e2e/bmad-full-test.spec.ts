...
test.describe('2. 학습 자료 관리 테스트', () => {
  ...
  test('2.1 PDF 업로드 및 처리', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/materials');
...
test.describe('3. 모의시험 테스트', () => {
  ...
  test('3.1 시험 시작', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/test');
  ...
  test('3.2 시험 진행', async ({ page }) => {
    ...
    await page.goto('http://localhost:3030/dashboard/test/mock');
...
test.describe('4. 지식 그래프 테스트', () => {
  ...
  test('4.1 3D 시각화', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/knowledge-graph');
...
test.describe('5. 결제 시스템 테스트', () => {
  ...
  test('5.1 구독 플랜 선택', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/pricing');
  ...
  test('5.3 VIP Pass', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/settings');
...
test.describe('6. 대시보드 및 통계 테스트', () => {
  ...
  test('6.2 캘린더 뷰', async ({ page }) => {
    await page.goto('http://localhost:3030/dashboard/calendar');
...
test.describe('7. 관리자 기능 테스트', () => {
  ...
  test('7.1 사용자 관리', async ({ page }) => {
    await page.goto('http://localhost:3030/admin/users');
  ...
  test('7.2 콘텐츠 관리', async ({ page }) => {
    await page.goto('http://localhost:3030/admin/content');
