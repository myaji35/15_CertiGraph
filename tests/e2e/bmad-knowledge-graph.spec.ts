...
test.describe('BMad 지식 그래프 테스트', () => {
  test.beforeEach(async ({ page }) => {
    // 페이지 로딩 개선: domcontentloaded 대기 (networkidle은 너무 느림)
  ...
  test('153. 개념 관계 매핑', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1`);
  ...
  test('161. 약점 개념 식별', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/weakness-analysis`);
  ...
  test('164. 약점 추적 히스토리', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/weakness-history`);
  ...
  test('165. 연관 약점 분석', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/weakness-analysis/1`);
  ...
  test('167. 최단 학습 경로 계산', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/learning-path/optimize`);
  ...
  test('168. 학습 경로 진행률', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/learning-path/1`);
  ...
  test('169. 경로 난이도 조절', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/learning-path/1/settings`);
  ...
  test('171. 개념 수동 추가', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/edit`);
  ...
  test('175. 개념 태그 관리', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/concepts/1`);
  ...
  test('176. 중심성 분석', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/analysis`);
  ...
  test('178. 학습 효율성 분석', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/efficiency`);
  ...
  test('179. 개념 간 거리 계산', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/distance`);
...
test.describe('지식 그래프 고급 기능', () => {
  test('A01. GraphRAG 질의', async ({ page }) => {
    await loginAsUser(page);
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/query`);
  ...
  test('A03. 협업 그래프 편집', async ({ page, context }) => {
    ...
    await page.goto(`${FRONTEND_URL}/knowledge-graph/1/collaborate`);

    // Simulate another user
    const page2 = await context.newPage();
    await loginAsUser(page2);
    await page2.goto(`${FRONTEND_URL}/knowledge-graph/1/collaborate`);
